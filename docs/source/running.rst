...
.. code-block:: yaml
	...
	package_data:
		...
		sim: RAFIKI_A             #Options: SIMBA, EAGLE, RAFIKI_A-I 
		redshift: 0.1
	...
	selection:
		...
		property_ranges:             
			...
			stellar_mass_min: 1e11       # Solar Masses (null=no cut)
		...
		catalog:
			path: /path/to/downloaded/erosita_comparison.csv            #Comparison catalog
		...
		redshift_sampling:
			...
			observational_catalog: /path/to/downloaded/erosita_comparison.csv        #If not using fixed, comparison catalog with sample z (if redshift mode) or sample z and mass if (mass_redshift mode)
	...
	output:
		...
		label: quickstart #Output file preflix 
